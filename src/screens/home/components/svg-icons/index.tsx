...
const gridIcon = <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16">
    ...
    <path fillRule="evenodd" clipRule="evenodd"
          ...
          fill="var(--color-IconNormal)"></path>
</svg>

const bidIcon = <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16">
    <g>
...
const askIcon = <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16">
    <g>
        <path d="M2.66663 2.66699L7.33329 2.66699L7.33329 13.3337L2.66663 13.3337L2.66663 2.66699Z"
              fill="var(--ask-bg-color)"></path>
        <path fillRule="evenodd" clipRule="evenodd"
...
export {gridIcon, askIcon, bidIcon}
